...
const AllClasses = () => {
  ...
  return (
    <div className="w-11/12 mx-auto py-28 bg-transparent">
      <Helmet>
      ...
      {pageCount > 1 && (
        <ReactPaginate
          ...
          pageClassName="overflow-hidden rounded-xl border border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-transparent backdrop-blur-md transition-all duration-300 hover:border-secondary dark:hover:border-secondary"
          pageLinkClassName="px-4 py-2 text-sm font-semibold text-gray-800 dark:text-gray-600 hover:text-gray-900 dark:hover:text-white block"
          activeClassName="bg-secondary dark:bg-secondary shadow-primary/20"
          activeLinkClassName="text-white dark:text-white hover:text-white dark:hover:text-white"
