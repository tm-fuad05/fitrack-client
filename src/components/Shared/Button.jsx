...
const Button = ({ textColor, hoverText, text }) => {
  return (
    <button
      className={`capitalize flex justify-center items-center gap-3 py-2 px-4 font-medium  bg-transparent rounded-full text-${textColor} hover:translate-x-2 duration-300 border  hover:bg-gradient-to-l hover:from-secondary hover:to-primary group  hover:text-${hoverText}`}
    >
      {text}
